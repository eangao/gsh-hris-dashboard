...
const ManagerEmployeeAttendance = () => {
  ...
  useEffect(() => {
    if (attendances && attendances.length > 0) {
      ...
      // Create a local copy of the attendance data
      let allAttendanceData = [...attendances];

      // Filter attendance records based on search value
      if (searchValue) {
        allAttendanceData = allAttendanceData.filter(
          (record) =>
            record.employeeName &&
            record.employeeName
              .toLowerCase()
  ...
  }, [searchValue, attendances, dispatch]); // Handle department change
      ...
      {selectedDepartment && (
        <div className="bg-white shadow-sm rounded-lg p-6 mb-6 border border-gray-200">
          <EmployeeSearch
            ...
            employees={dutySchedule?.employees || employees || []}
