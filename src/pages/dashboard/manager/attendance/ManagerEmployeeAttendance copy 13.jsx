...
const ManagerEmployeeAttendance = () => {
  ...
  useEffect(() => {
    if (originalAttendances && originalAttendances.length > 0) {
      ...
      // Only reset to page 1 if current page is beyond available pages after filtering
      const totalPages = Math.ceil(filteredData.length / perPage);
      if (currentPage > totalPages && totalPages > 0) {
        console.log(
          `Current page ${currentPage} exceeds total pages ${totalPages}, resetting to 1`
        );
        setCurrentPage(1);
      }
    } else if (
  ...
  }, [searchValue, originalAttendances, employees, perPage]); // currentPage is NOT a dependency
