            ...
            <div className="flex flex-col md:flex-row md:items-center md:gap-4">
              <div className="flex-1 mb-4 md:mb-0">
                ...
                <select
                  ...
                  className="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:border-blue-600 transition-colors"
                >
              ...
              <div className="flex-shrink-0 flex items-center bg-blue-50 px-4 py-2 rounded-md">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-5 w-5 text-blue-600 mr-2"
                  viewBox="0 0 20 20"
      ...
      {loading ? (
        ...
        <>
          ...
          <div className="bg-white shadow-sm rounded-lg overflow-hidden border border-gray-200">
            ...
            {/* Pagination */}
            {selectedDepartment && totalAttendance > perPage && (
              <div className="mt-6 bg-white rounded-lg shadow-sm border overflow-hidden">
                <div className="px-6 py-4 bg-gradient-to-r from-gray-50 to-blue-50 border-b flex flex-col sm:flex-row sm:items-center sm:justify-between">
                  <div className="text-sm text-gray-700 mb-4 sm:mb-0 flex items-center">
                    ...
                    to{" "}
                    <span className="font-medium text-blue-700 mx-1">
                      {Math.min(currentPage * perPage, totalAttendance)}
                    </span>{" "}
                    of{" "}
                    <span className="font-medium text-blue-700 mx-1">
                      {totalAttendance}
                  ...
                  <div className="flex justify-center sm:justify-end">
                    <Pagination
                      ...
                      setPageNumber={(page) => {
                        // Set loading first, then update the page
                        if (page !== currentPage) {
                          setIsLoadingPage(true);
                          setCurrentPage(page);
                        }
                      }}
                      totalItem={totalAttendance}
                      perPage={perPage}
                      showItem={Math.min(
                        5,
                        Math.ceil(totalAttendance / perPage)
                      )}
                    />
                  </div>
                </div>
