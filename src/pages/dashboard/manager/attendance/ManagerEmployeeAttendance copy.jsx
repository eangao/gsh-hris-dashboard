...
const ManagerEmployeeAttendance = () => {
  ...
  // State for managing multiple duty schedules
  ...
  }, [canNavigatePrevious, currentScheduleIndex, availableDutySchedules]); // Clear attendance data when component unmounts
  useEffect(() => {
    return () => {
  ...
  useEffect(() => {
    if (dutySchedules && dutySchedules.length > 0) {
      // console.log("dutySchedules:", dutySchedules);
