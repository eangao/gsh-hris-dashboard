...
const MyAttendance = () => {
  ...
  const TimeDisplay = ({ time, type = "in" }) => {
    ...
    const formattedTime =
      typeof time === "string" ? time : formatTimeTo12HourPH(new Date(time));
                        ...
                        {attendance.morningInLog &&
                          attendance.afternoonInLog && (
                            <div className="text-xs text-gray-500 mt-1">
                              AM:{" "}
                              {formatTimeTo12HourPH(
                                new Date(attendance.morningInLog)
                              )}
                            </div>
                          )}
                      </div>
                        ...
                        {attendance.morningOutLog &&
                          attendance.afternoonOutLog && (
                            <div className="text-xs text-gray-500 mt-1">
                              PM:{" "}
                              {formatTimeTo12HourPH(
                                new Date(attendance.afternoonOutLog)
                              )}
                            </div>
                          )}
                      </div>
                          ...
                          <div className="text-red-600 font-medium">
                            ...
                            {attendance.morningLateMinutes > 0 && (
                              <div className="text-xs text-red-500">
                                AM: {attendance.morningLateMinutes}m
                              </div>
                            )}
                            {attendance.afternoonLateMinutes > 0 && (
                              <div className="text-xs text-red-500">
                                PM: {attendance.afternoonLateMinutes}m
                              </div>
                            )}
                          </div>
                        ) : (
